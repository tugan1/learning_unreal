...
#define ORIGINAL_FILE_NAME "UE4Editor-cpp_quickstart.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME cpp_quickstart
#define DEPRECATED_FORGAME DEPRECATED
#define CPP_QUICKSTART_API DLLEXPORT
